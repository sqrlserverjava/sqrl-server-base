...
public class SqrlNutToken {
	 ...
	 */
	public SqrlNutToken(final int inetInt, final SqrlConfigOperations configOps, final int counter, final long timestamp,
			final int randomInt) throws SqrlException {
	 ...
	 * {@link SqrlNutToken#Nut(int, SqrlConfig, int, long, int)} was called with a timestamp of <code>1463948680679</code>, then
	 * {@link #getIssuedTimestamp()} would return <code>1463948680000</code>
	 * 
