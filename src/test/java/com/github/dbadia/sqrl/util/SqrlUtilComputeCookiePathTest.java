...
public class SqrlUtilComputeCookiePathTest {

	// @formatter:off
	@Parameters(name = "{index}: SqrlClientOpt=({0})")
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
			{ "/blah", "https://sqrljava.tech/blah" },
			{ "/blah", "https://sqrljava.tech/blah/" },
			{ "/blah", "https://sqrljava.tech:20165/blah/"},
			{ "/blah/more", "https://sqrljava.tech/blah/more" },
			{ "/blah/more", "https://sqrljava.tech/blah/more/" },
			{ "/blah/more", "https://sqrljava.tech:20165/blah/more"},
		});
	}
	...
	public void testIt() {
		...
		final String result = SqrlUtil.computeCookiePath(mockRequest, config);
