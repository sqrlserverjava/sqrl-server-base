...
public class SqrlConfigOperationsUrlTest {
	...
	public static Collection<Object[]> data() {
		...
		return Arrays.asList(new Object[][] { 
			...
			// expected subsequent,
			{ "sqrlbc", "http://127.0.0.1:8080/sqrlexample/login", "qrl://127.0.0.1:8080/sqrlexample/sqrlbc", "/sqrlexample/sqrlbc",},
			{ "/sqrlexample/sqrlbc", "http://127.0.0.1:8080/sqrlexample/login", "qrl://127.0.0.1:8080/sqrlexample/sqrlbc", 
				"/sqrlexample/sqrlbc",},
			{ "http://127.0.0.1:8080/sqrlexample/sqrlbc", "http://127.0.0.1:8080/sqrlexample/login", 
					"qrl://127.0.0.1:8080/sqrlexample/sqrlbc", "/sqrlexample/sqrlbc",},
			// Test subdomain
