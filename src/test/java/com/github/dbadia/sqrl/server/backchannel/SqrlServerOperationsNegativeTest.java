...
public class SqrlServerOperationsNegativeTest {
	private static final String CLIENT_DATA_1_NUT_IP = "141.119.117.205";
	...
	public void testNutReplayed() throws Throwable {
		...
		final Map<String, String> responseDataTable = SqrlServerOperationsClientTest
		...
		assertEquals("64", responseDataTable.get("tif"));
	}
